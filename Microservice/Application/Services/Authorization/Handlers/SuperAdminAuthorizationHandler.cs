...
{
    public class SuperAdminAuthorizationHandler : AuthorizationHandler<SuperAdminRequirements>
    {
        //Write the logic to verify that an authenticated user meets to perform a certain action (CanRead action)
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, SuperAdminRequirements requirement)
        {
